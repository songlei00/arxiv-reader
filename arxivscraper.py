"""
Modified from https://github.com/Mahdisadjadi/arxivscraper/blob/main/arxivscraper/arxivscraper.py
"""
                ...
                if self.append_all:
                    ...
                    for key in self.keys:
                        for word in self.filters[key]:
                            if word.lower() in record[key].lower():
                                save_record = True
                    ...
                    if save_record:
                        ...
                        for key in record:
                            if key == 'abstract':
                                continue
                            meta_info[key].append(record[key])
